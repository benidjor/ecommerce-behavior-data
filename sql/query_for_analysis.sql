...
SELECT 
    TO_CHAR(ft.event_time_ymd, 'YYYY-MM') AS event_time_month,
    ft.event_time_day_name,
    ft.event_time_hour,
    ft.event_type,
...
FROM ECOMMERCE_DATA.STAGING_DATA.FACT_CATEGORY_PRODUCT_TIME AS ft
WHERE event_type = 'purchase'
GROUP BY TO_CHAR(ft.event_time_ymd, 'YYYY-MM'), ft.event_time_day_name, ft.event_time_hour, ft.event_type;
